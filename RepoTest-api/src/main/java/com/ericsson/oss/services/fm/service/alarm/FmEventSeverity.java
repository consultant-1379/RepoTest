 ...
 *
 */
@ModeledEventDefinition(persistenceType = PersistenceType.NON_PERSISTENT, defaultChannelId = "FMMediationChannel", description = "FmEventSeverity", version = "1.0.0")
public enum FmEventSeverity {
