 ...
 *
 */
@ModeledEventDefinition(persistenceType = PersistenceType.NON_PERSISTENT, defaultChannelId = "FMMediationChannel", description = "FmMediationEventAckStatus", version = "1.0.0")
public enum FmMediationEventAckStatus {
