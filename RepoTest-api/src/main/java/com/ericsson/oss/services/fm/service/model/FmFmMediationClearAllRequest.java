 ...
 * 
 */
@ModeledEventDefinition(persistenceType = PersistenceType.NON_PERSISTENT, defaultChannelId = "EventBasedMediationClient", description = "FmFmMediationClearAllRequest", version = "1.0.0")
public class FmFmMediationClearAllRequest extends MediationTaskRequest {
}
