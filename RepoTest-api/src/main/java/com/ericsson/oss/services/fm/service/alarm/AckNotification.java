 ...
 *
 */
@ModeledEventDefinition(persistenceType = PersistenceType.NON_PERSISTENT, defaultChannelId = "FMMediationChannel", description = "AckNotification", version = "1.0.0")
public class AckNotification extends FmMediationNotification implements
		Serializable {
